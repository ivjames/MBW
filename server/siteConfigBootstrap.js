export const SITE_CONFIG_BOOTSTRAP = {
    company: {
        name: 'Buzzworthy',
    ...
    footer: {
        tagline: 'Conversion-focused digital agency. Strategy, design, and development aligned.',
        columns: [
            {
                title: 'Services',
                links: [
                    ...
                    { label: 'SEO Optimisation', href: '/seo-optimisation' },
